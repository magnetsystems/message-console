define(['jquery', 'backbone'], function($, Backbone){
    var View = Backbone.View.extend({
        el: '#completeregistration-container',
        initialize: function(options){
            var me = this;
            me.options = options;
            me.options.eventPubSub.bind('initCompleteRegistration', function(){
                me.fillCountries();
        ...
        register: function(e){
            ...
            if(me.validate(me.$el) === true){
                ...
                var tosDialog = $('#confirm-tos-dialog');
                if(tosDialog.length){
        ...
        fillCountries: function(){
            ...
            for(var i=0;i<this.countries.length;++i)
                html += '<option value="'+this.countries[i].short+'">'+this.countries[i].name+'</option>';
            this.$el.find('select[name="country"]').html(html);
        },
        countries: [
