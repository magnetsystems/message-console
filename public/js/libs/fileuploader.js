 ...
 * Next Maintainer (2.0+): Â© 2012, Ray Nicholus ( fineuploader(at)garstasio.com )
 * Current Maintainer (3.X (MIT Branch)): Â© 2013, Simon Waldherr ( contact(at)simonwaldherr.de )
 * Modified by Magnet Systems, Inc to force application/octet-stream upload
 *
...
qq.UploadHandlerXhr = function (o, uploadCompleteCallback, logCallback) {
    ...
    setHeaders = function (id, xhr) {
        ...
        if (!multipart) {
            ...
            xhr.setRequestHeader("X-File-Name", fileOrBlob.name);
