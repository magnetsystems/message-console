define(['jquery', 'backbone'], function($, Backbone){
    var View = Backbone.View.extend({
        ...
        events : {
            ...
            'click #mmx-app-list table tbody td .topic-delete-btn': 'deleteTopic',
            'click #mmx-app-list table tbody td .topic-publish-btn': 'showPublishModal'
        },
        ...
        deleteTopic: function(e){
            ...
            AJAX('apps/'+me.model.attributes.id+'/topics/'+row.attr('did'), 'DELETE', 'application/json', null, function(res, status, xhr){
                utils.removeByAttr(me.topics.results, 'id', row.attr('did'));
        ...
        showPublishModal: function(e){
            ...
            this.activeTopic = utils.getByAttr(this.topics.results, 'id', tid);
        ...
        publishTopic: function(){
            ...
            AJAX('apps/'+me.model.attributes.id+'/topics/'+me.activeTopic.id+'/publish', 'POST', 'application/json', {
                payload : msg.val()
            }, function(res, status, xhr){
                msg.val('');
                alert('message sent');
